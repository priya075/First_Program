...
{
    public partial class VwLmFacCalBaseCcy
    {
        ...
        public decimal? ApprovedLimitBaseCcy { get; set; }
        public decimal? ProposedLimitBaseCcy { get; set; }
        public decimal? IpaProposedLimitBaseCcy { get; set; }
        public decimal? IpaApprovedLimitBaseCcy { get; set; }
        public bool? IsDirect { get; set; }
        public int? Fcsid { get; set; }
        public string? Class { get; set; }
        public string? ClassDescription { get; set; }
        public decimal? ApprovedLimitBaseCcyRec { get; set; }
        public decimal? ProposedLimitBaseCcyRec { get; set; }
    }
}
