...
{
    public partial class VwMistrackerHistoryDetail
    {
        ...
        public string? ReasonsOfDeclineWithdrawnRejection { get; set; }
        public string? ReasonsOfDeclineWithdrawnAdditionalRemarks { get; set; }
        public string? ApprovingAuthority { get; set; }
        public string? IsManualOverride { get; set; }
        public string? ManualOverrideDop { get; set; }
        public string? ManualOverrideComments { get; set; }
        public string? CreditApproverName { get; set; }
        public string SecretoryVote { get; set; } = null!;
        public string? CreditSecName { get; set; }
        ...
        public string? Cibildate { get; set; }
    }
}
